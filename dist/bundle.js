	...
	var WorkingDirectory = (function () {
	  ...
	  _createClass(WorkingDirectory, [{
	    ...
	    value: function guard(message, fn) {
	      ...
	      var push = function push(err) {
	        if (err) {
	          fn(err);
	          return;
	        }
	        _GitService2.default.push(origin, path, fn);
	      };

	      var commit = function commit() {
	        _GitService2.default.commit(path, message, push);
	      };
	      ...
	      if (_GitService2.default.isGitRepository(path)) {
	        ...
	        _GitService2.default.initializeRepository(path, origin, commit);
	      }
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  setOrigin: function setOrigin(path, remote, fn) {
	    var command = 'git remote add origin ' + remote;
	    console.log(command);
	    this._exec(command, path, fn);
	  },
	  initializeRepository: function initializeRepository(path, remote, fn) {
	    var _this = this;

	    var command = "git init";
	    var addRemote = function addRemote() {
	      _this.setOrigin(path, remote, fn);
	    };
	  ...
	  push: function push(remote, path, fn) {
	    var command = "git push origin master";
	    this._exec(command, path, fn);
	  },
	  _exec: function _exec(command, path, fn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ConfigModal = __webpack_require__(26);
	...
	var Workspace = (function (_React$Component) {
	  ...
	  _createClass(Workspace, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      _Menu.menuEmitter.on('open', function () {
	        return _this4.openFile();
	      });
	      _Menu.menuEmitter.on('save', function () {
	        return _this4.saveFile();
	      });
	      _Menu.menuEmitter.on('toggle-timeline', function () {
	        _this4.setState({ activateSideBar: !_this4.state.activateSideBar });
	      });
	      _Menu.menuEmitter.on('save-as', function () {});
	      _Menu.menuEmitter.on('guard', function () {
	    ...
	    value: function _onGuardKeyDown(evt, value) {
	      ...
	      this.state.cwd.guard(value, function (err) {
	        if (err) {
	          ...
	          evt.target.value = '';
	          _this5.setState({ activateSideBar: false });
	        }
	      });
	    }
	  }, {
	    ...
	    key: '_getWordCount',
	    value: function _getWordCount(contents) {
	      if (typeof contents === "string") {
	        return (contents.trim().replace(/['";:,.?¿\-!¡]+/g, '').match(/\S+/g) || []).length;
	      } else {
	        return 0;
	      }
	    }
	    ...
	    key: '_onNavSelect',
	    value: function _onNavSelect(sideBarMode) {
	      this.setState({ sideBarMode: sideBarMode });
	    }
	  }, {
	    key: 'render',
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_SideBar2.default, {
	          ...
	          onSelect: function onSelect(mode) {
	            return _this6._onNavSelect(mode);
	          },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SideBarNav = __webpack_require__(24);

	var _SideBarNav2 = _interopRequireDefault(_SideBarNav);

	var _GuardView = __webpack_require__(25);

	var _GuardView2 = _interopRequireDefault(_GuardView);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        {
	          ...
	          id: "timeline" },
	        _react2.default.createElement(_SideBarNav2.default, {
	          onSelect: this.props.onSelect,
	          mode: this.props.mode }),
	        _react2.default.createElement(_GuardView2.default, {
	          activate: this.props.mode === "guard",
	          onGuardKeyDown: function onGuardKeyDown(evt) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActivatableNavItem = (function (_React$Component) {
	  _inherits(ActivatableNavItem, _React$Component);

	  function ActivatableNavItem() {
	    _classCallCheck(this, ActivatableNavItem);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ActivatableNavItem).apply(this, arguments));
	  }

	  _createClass(ActivatableNavItem, [{
	    key: "render",
	    value: function render() {
	      var _this2 = this;
	        ...
	        _react2.default.createElement(
	          ...
	          { href: this.props.link,
	            onClick: function onClick() {
	              return _this2.props.onSelect(mode);
	            },
	            className: className },
	          this.props.text
	        )
	  ...
	  return ActivatableNavItem;
	})(_react2.default.Component);

	var SideBarNav = (function (_React$Component2) {
	  _inherits(SideBarNav, _React$Component2);

	  function SideBarNav() {
	    _classCallCheck(this, SideBarNav);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SideBarNav).apply(this, arguments));
	  }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "ul",
	            { className: "tabs" },
	            _react2.default.createElement(ActivatableNavItem, {
	              mode: "guard",
	              onSelect: this.props.onSelect,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GuardView = (function (_React$Component) {
	  _inherits(GuardView, _React$Component);

	  function GuardView(props) {
	    _classCallCheck(this, GuardView);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GuardView).call(this, props));
	  ...
	  _createClass(GuardView, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      if (nextProps.activate) {
	        ...
	        if (this.props.activate) {
	          className += " slideOutDown";
	          var hideAfterSlide = function hideAfterSlide() {
	            _this2.setState({ className: "hide" });
	            $('#guard-view').off();
	          };
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        { id: "guard-view", className: this.state.className },
	        _react2.default.createElement("input", {
	          onKeyDown: function onKeyDown(evt) {
	            return _this3.props.onGuardKeyDown(evt);
	          },
	          autoFocus: true,
	...
	var MetaData = (function (_React$Component) {
	  ...
	  _createClass(MetaData, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        { className: "full-width metadata-view" },
	        _react2.default.createElement(
	          "span",
	          { className: "small" },
	          "Word Count: ",
